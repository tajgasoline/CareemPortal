...
<body>
   ...
   <!--  <div class="form-group row">
              ...
              <div class="col-md-1"> </div>
                ...
                <div class="col-md-2"> 
                  <button type="button" id="btnprint" disabled onclick="Printinvoice();" class="btn btn-primary waves-effect waves-light" style="width: 100%;">Print</button>
              </div>
              <div class="col-md-1"> </div>
             

               <div class="col-md-2"> 
                  <button type="button" onclick="reload();" class="btn btn-primary waves-effect waves-light" style="width: 100%;">Clear</button>
              </div>
