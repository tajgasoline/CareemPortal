...
if(isset($_POST['Search']) )
{
	...
	$query = "select   id,captainid,vehicleid,vehiclenumber,customername,contactnumber,vehicletype,status from careemportalcustomers where (vehiclenumber = '".$Search."'  or RIGHT(contactnumber,10) = RIGHT('".$Search."',10)  or captainid = '".$Search."') ";
